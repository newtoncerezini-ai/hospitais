...
const makeUnit = (overrides: Partial<HealthUnit> = {}): HealthUnit => ({
  ...
  cofinancing2022: { amount: null, label: null },
  cofinancing2025: { amount: null, label: null },
  ...
  professionalBreakdown: {
    ...
    pj: null,
    outsourced: null,
    youngApprentices: null,
    temporaryContracts: null,
    secondedFromOtherAgencies: null,
  },
  mainAdvances: null,
  sourceText: null,
  latitude: null,
  longitude: null,
  source: { sheet: "Consolidado", row: 2, supplemental: null, references: [], inheritedFields: [] },
  enrichment: {
  ...
  const units = [
    ...
    makeUnit({
      ...
      source: {
        sheet: "Consolidado",
        row: 67,
        supplemental: { sheet: "UNIDADES EM CONSTRUÇÃO", row: 2 },
        references: [],
        inheritedFields: [],
      },
    }),
